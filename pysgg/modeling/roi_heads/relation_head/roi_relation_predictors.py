...
class SquatPredictor(nn.Module): 
    ...
    def forward(self, inst_proposals, rel_pair_idxs, rel_labels, rel_binarys, roi_features, union_features, logger=None,bert_score=None,bert_embedding=None): 
        """
        ...
        score_obj, score_rel, masks = self.context_layer(
            roi_features, inst_proposals, union_features, rel_pair_idxs, rel_binarys,bert_score=bert_score,bert_embedding=bert_embedding
        ) # masks : [list[Tensor]]

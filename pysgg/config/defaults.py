...
_C.MODEL.BERT = CN()
_C.MODEL.BERT.USE_BERT_SCORE = False
_C.MODEL.BERT.USE_BERT_EDGE_EMBED = False
_C.MODEL.BERT.EMBEDDING_DIM = 768
_C.MODEL.BERT.USE_OBJ = False
_C.MODEL.BERT.OBJ_PATH = 'obj.pkl'
_C.MODEL.BERT.OBJ_DIM = 768
_C.MODEL.BERT.SCORE_PATH = 'score.pkl'
_C.MODEL.BERT.EDGE_PATH = 'edge.pkl'